# ld35boilerplate
This is the boilerplate code I plan to use for for Ludum Dare 35.  It's a lightly modified
version of the [Phaser ES6 Boilerplate](https://github.com/belohlavek/phaser-es6-boilerplate) by [Daniel Belohlavek](https://github.com/belohlavek). I just added a few states and some starter code, which ended up being not nearly as much as I would have liked :)
